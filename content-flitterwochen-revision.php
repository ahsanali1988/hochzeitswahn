...
<article id="post-<?php the_ID(); ?>" <?php post_class('hw_flitterwochen type-hw_flitterwochen'); ?>>
  ...
  <?php
    ...
    echo '<div class="post-categories">';
      $categories = get_the_terms( $parentID, 'flitter_categorie' );
      ...
      $regionen = get_the_terms( $parentID, 'flitter_region' );
  ...
  <aside class="entry-details">
    ...
    <div class="entry-details-top">
      ...
      <div class="details-top-img">
        ...
        ?>
        <span class="sharing-options" data-modal-id="<?php echo $parentID;?>">
