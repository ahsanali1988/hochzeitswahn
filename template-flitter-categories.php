<?php
/**
 * Template Name: Flitterwochen Kategorie Uebersicht
 * Description: Template zur Darstellung aller Kategorien der Flitterwochen
 *
  ...
  <main id="main" class="site-main" role="main">
    ...
    <nav class="sub-category-nav">
      ...
      <ul class="sub-cat-nav-catlist unstyled">
        ...
        <?php $flitter_categories = get_terms('flitter_categorie'); foreach($flitter_categories as $category) : ?>
              ...
              <div class="entry-thumbnail">
                ...
                <a href="<?php echo get_term_link( $category ); ?>" title="<?php echo $category->name; ?>">
                  ...
                  <?php
                    ...
                    $image = get_field('flitter_cat_img', $taxonomy . '_' . $term_id);
