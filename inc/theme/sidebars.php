...
if ( function_exists('register_sidebar') ) {
  function fw_register_sidebars() {
	  register_sidebar(array(
	  	'id' => 'sidebar1',
	  	'name' => __('Default Sidebar', 'jointstheme'),
	  	'description' => __('Default Sidebar.', 'jointstheme'),
...
//  	  $sidebars = (new sidebar_generator)->get_sidebars();
//        
//  	  if(is_array($sidebars)){
//  		foreach($sidebars as $sidebar){
//  			$sidebar_class = (new sidebar_generator)->name_to_class($sidebar);
//  				register_sidebar(array(
//  					'name'=>$sidebar,
...
//  		$id = (new sidebar_generator)->name_to_class($name);
//  		if(isset($sidebars[$id])){
//  			die("alert('Sidebar already exists, please use a different name.')");
//  		}
//  		
//  		$sidebars[$id] = $name;
//  		(new sidebar_generator)->update_sidebars($sidebars);
//  		
//  		$js = "
...
//  					<td><?php echo (new sidebar_generator)->name_to_class($sidebar); ? ></td>
...
//  		$is_saving = isset( $_POST['sbg_edit'] ) ? esc_attr( $_POST['sbg_edit'] ) : '';
//  		if(!empty($is_saving)){
...
//  	(new sidebar_generator)->get_sidebar($name);	
//  	return true;
//  }
