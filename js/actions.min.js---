(function() {
    ...
    $(window).load(function(){
        var p = $(".single-post .entry-gallery").imagesLoaded(function() {
            $(".single-post .gallery-loader").hide(), $(".single-post .entry-gallery").show(), p.masonry({
    ...
    $(window).load(function(){
        var u = $(".page-template-template-gallery-scroll-php .entry-gallery , .page-template-template-gallery .entry-gallery");
        "" !== u && (u.hide(), imagesLoaded($(".page-template-template-gallery-scroll-php .entry-gallery , .page-template-template-gallery .entry-gallery"), function() {
            u.masonry({
        ...
        })) }), $(".page-template-template-gallery .entry-gallery").length > 0 && ($(".open-hover").on("click", function() {
