  ...
  <aside class="entry-details">
    ...
    <div class="entry-details-top">
      ...
      <div class="details-top-content">
        <h1> <?php the_field('wahn_profil_name'); ?> </h1>
        
        <ul class="unstyled details-top-content-basics">
          <?php if( get_field('wahn_profil_website') ) : ?> <li> <a href="<?php the_field('wahn_profil_website'); ?>" title="<?php the_field('wahn_profil_name'); ?>" target="_blank">Zur Webseite</a> </li> <?php endif; ?>
          <?php if( get_field('wahn_profil_email') ) : ?> <li> <a href="#modal-contact_DL" title=""> Unverbindlich anfragen</a> </li> <?php endif; ?>
          <?php if( get_field('wahn_profil_telefon') ) : ?> <li> <span><?php _e('Telefon:', 'fwbase'); ?></span> <?php the_field('wahn_profil_telefon'); ?> </li> <?php endif; ?>                      
          <li>
          ...
          <?php if( get_field('wahn_profil_standort') ) : ?> <li> 
            <span><?php _e('Standorte:', 'fwbase'); ?></span> 
                        
            <?php              
             
              if( have_rows('wahn_profil_standort') ) : $counter = 1; while ( have_rows('wahn_profil_standort') ) : the_row();     
                ...
                if( !get_sub_field('wahn_profil_standort_maps') ) {
                  ...
                  echo '<a href="#modal-map" title="Google Maps Link" class="acf-maps-modal" rel="nofollow">'.get_sub_field('wahn_profil_standort_ort').'</a>';
                ...
                if( $counter != count(get_field('wahn_profil_standort')) ) echo ', '; $counter++;         
          ...
          <?php if(get_field('wahn_profil_mobilitaet')) { ?> <li> <span><?php _e('Bereit zu Reisen:', 'fwbase'); ?></span> <?php _e('Ja', 'fwbase'); ?> </li> <?php } ?> 
        </ul>
       
        <ul class="unstyled details-top-content-social">
          <?php if( get_field('wahn_facebook') ) :   ?> <li> <a href="<?php the_field('wahn_facebook');   ?>" target="_blank" title="Facebook" rel="nofollow"> <span class="icon-facebook"></span> </a> </li> <?php endif; ?>
          <?php if( get_field('wahn_twitter') ) :    ?> <li> <a href="<?php the_field('wahn_twitter');    ?>" target="_blank" title="Twitter" rel="nofollow"> <span class="icon-twitter"></span> </a> </li> <?php endif; ?>
          <?php if( get_field('wahn_pinterest') ) :  ?> <li> <a href="<?php the_field('wahn_pinterest');  ?>" target="_blank" title="Pinterest" rel="nofollow"> <span class="icon-pinterest"></span> </a> </li> <?php endif; ?>
          <?php if( get_field('wahn_instagram') ) :  ?> <li> <a href="<?php the_field('wahn_instagram');  ?>" target="_blank" title="Instagram" rel="nofollow"> <span class="icon-instagram"></span> </a> </li> <?php endif; ?>
          <?php if( get_field('wahn_googleplus') ) : ?> <li> <a href="<?php the_field('wahn_googleplus'); ?>" target="_blank" title="Google Plus" rel="nofollow"> <span class="icon-google"></span> </a> </li> <?php endif; ?>
          <?php if( get_field('wahn_blog') ) :       ?> <li> <a href="<?php the_field('wahn_blog');       ?>" target="_blank" title="Blog" rel="nofollow"> <span class="icon-blog"></span> </a> </li> <?php endif; ?>
        </ul>
...
//          echo '<li class="flex-video"> <div>'.wp_oembed_get( get_sub_field( 'wahn_video_embed' ) ).'</div> </li>';
// deprecated since 02.02.16 iframe error becaus of plugin conflict
			
			$wahnvid = get_sub_field( 'wahn_video_embed');
			
			if (stripos($wahnvid, 'www.') !== false) { // make this if it is a link with a url
				echo '<li class="flex-video"> <div>'.wp_oembed_get( get_sub_field( 'wahn_video_embed') ).'</div> </li>';
			}

			elseif (stripos($wahnvid, '[vimeo') !== false) { // make this when it's a shortcode [vimeo id="45454545"]
	            echo '<li class="flex-video"> <div>'.do_shortcode(get_sub_field( 'wahn_video_embed')).'</div> </li>'; 
			}

			else { // make this if it's just an ID
				echo '<li class="flex-video"> <div>'.do_shortcode('[vimeo id="'.get_sub_field('wahn_video_embed').'"]').'</div> </li>'; 
			}
      ...
      <ul class="entry-slider-nav unstyled">
        ...
        <?php if( have_rows('wahn_video') ) : while ( have_rows('wahn_video') ) : the_row(); ?>
