      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="vendor_name">
            <h1>
              <?php the_field('wahn_profil_name',$firstPost); ?>
            </h1>
        ...
        <div class="col-sm-6">
          <div class="vendor_social_icons">
            <ul>
              <?php if (get_field('wahn_facebook',$firstPost)) : ?>
              <li> <a href="<?php the_field('wahn_facebook',$firstPost); ?>" target="_blank" title="Facebook" rel="nofollow"> <span class="icon-facebook"></span> </a> </li>
              <?php endif; ?>
              <?php if (get_field('wahn_twitter',$firstPost)) : ?>
              <li> <a href="<?php the_field('wahn_twitter',$firstPost); ?>" target="_blank" title="Twitter" rel="nofollow"> <span class="icon-twitter"></span> </a> </li>
              <?php endif; ?>
              <?php if (get_field('wahn_pinterest',$firstPost)) : ?>
              <li> <a href="<?php the_field('wahn_pinterest',$firstPost); ?>" target="_blank" title="Pinterest" rel="nofollow"> <span class="icon-pinterest"></span> </a> </li>
              <?php endif; ?>
              <?php if (get_field('wahn_instagram',$firstPost)) : ?>
              <li> <a href="<?php the_field('wahn_instagram',$firstPost); ?>" target="_blank" title="Instagram" rel="nofollow"> <span class="icon-instagram"></span> </a> </li>
              <?php endif; ?>
              <?php if (get_field('wahn_googleplus',$firstPost)) : ?>
              <li> <a href="<?php the_field('wahn_googleplus',$firstPost); ?>" target="_blank" title="Google Plus" rel="nofollow"> <span class="icon-google"></span> </a> </li>
              <?php endif; ?>
              <?php if (get_field('wahn_blog',$firstPost)) : ?>
              <li> <a href="<?php the_field('wahn_blog',$firstPost); ?>" target="_blank" title="Blog" rel="nofollow"> <span class="icon-blog"></span> </a> </li>
              <?php endif; ?>
            </ul>
          </div>
    ...
    <div class="vendor_all_info_wrap">
      <div class="entry-details-top">
        <div class="details-top-img">
          <?php
                            if (get_field('wahn_profil_logo',$firstPost)) {
                                $logo = get_field('wahn_profil_logo',$firstPost);
        ...
        <div class="details-top-content">
          <ul class="unstyled details-top-content-basics">
            <?php if (get_field('wahn_profil_website',$firstPost)) : ?>
            <li class="web"><a href="<?php the_field('wahn_profil_website',$firstPost); ?>" title="" rel="nofollow" target="_blank"><i class='fa fa-globe'></i> Webseite</a></li>
            <?php endif; ?>
            <?php if (get_field('wahn_profil_telefon',$firstPost)) : ?>
            <li class="phone_no"><i class='fa fa-phone'></i> Anrufen</li>
            <script>
                                        jQuery(document).ready(function () {
                                             jQuery('.web').click(function () {
                                                 window.open('<?php the_field('wahn_profil_website',$firstPost); ?>','_blank');
                                                 });
                                            jQuery('.phone_no').click(function () {
                                                if(jQuery('#phn').val() == "2")
                                                {
                                                    window.location.href = 'tel:<?php the_field('wahn_profil_telefon',$firstPost); ?>';
                                                }
                                                var phone_no = '<?php the_field('wahn_profil_telefon',$firstPost); ?>'
            ...
            <?php if (get_field('wahn_profil_mobilitaet',$firstPost)) { ?>
            <li style="display:none;"> <span>
...
//                console.log();
      ...
      <div class="bio_description">
        <p>
        <?php $bio = the_field('profile_biography',$firstPost);?>
<?php echo(str_word_count("'.$category_link.'",25)); ?>	
</p>
      </div>
        <div class="text-center" style="margin-top: 30px;">
      <?php if (get_field('wahn_profil_email',$firstPost)) : ?>
      <a class="entry-details-contact button"  href="#modal-contact_DL" title="<?php _e('Kontaktiere', 'fwbase'); ?> <?php the_field('wahn_profil_name',$firstPost); ?>">
     <?php _e('Kontaktiere', 'fwbase'); ?> <?php the_field('wahn_profil_name',$firstPost); ?>
      </a>
      <?php endif; ?>
      </div>
    </div>
...
<!--      <h1>
      ...
      <div class="entry-details-descr">
        <?php the_field('wahn_profil_description',$firstPost); ?>
      </div>
    </div>
  </div>
  </div>
...
<!--<li class="relative video_emb"> <img class="lazy" width="1350" height="900" data-width="1350" data-height="900" src="https://www.hochzeitswahn.de/wp-content/uploads/2018/01/video_thumb.jpg" size="100vw" alt="">
  <div class="zoom-image"> <a href="https://vimeo.com/162199984" class="fancy_video" rel="vendor_gallery" title="">&nbsp;</a> </div>
              ...
              <?php
                $gallery = get_field('wahn_gallery',$firstPost);
                ?>
      ...
      <?php endforeach; ?>
           <?php
                    if (have_rows('wahn_video',$firstPost)) : while (have_rows('wahn_video',$firstPost)) : the_row();
					   $video_url = get_sub_field('video_thumb',$firstPost);
					   echo '<li class="item video_emb"> <img src="/wp-content/uploads/videoplay-default.jpg" class="lazy" width="1350" height="900" data-width="1350" data-height="900" size="100vw" alt=""><div class="zoom-image"><a href="'.get_sub_field('featured_video_embed',$firstPost).'" class="fancy_video" rel="vendor_gallery" title="">&nbsp;</a></div> </li>';
					   endwhile;
                    endif;
                    ?>
    ...
    <div class="vendor_all_info_wrap clone">
      <div class="entry-details-top">
        <div class="details-top-content">
          ...
          <ul class="unstyled details-top-content-basics">
            <?php if (get_field('wahn_profil_standort',$firstPost)) : ?>
            <li> <i class="fa fa-map-marker"></i> <span>
              <?php _e('Standort:', 'fwbase'); ?>
              </span>
              <?php
                                        if (have_rows('wahn_profil_standort',$firstPost)) : $counter = 1;
                                            while (have_rows('wahn_profil_standort',$firstPost)) : the_row();
												$map_id = get_the_ID();
                                                if (!get_sub_field('wahn_profil_standort_maps',$firstPost)) {

                                                    echo '<a  href="' . get_sub_field('wahn_profil_standort_url',$firstPost) . '" rel="nofollow" title="Google Maps Link" target="_blank">' . get_sub_field('wahn_profil_standort_ort',$firstPost) . '</a>';
                                                } else {

                                                    $location = get_sub_field('wahn_profil_standort_maps',$firstPost);
...
//                                                        print_r($location);
                                                    ...
                                                    echo '<a class = "1" href="#modal-map-'.get_sub_field('wahn_profil_standort_ort',$firstPost).'" title="Google Maps Link" class="acf-maps-modal" rel="nofollow">' . get_sub_field('wahn_profil_standort_ort',$firstPost) . '</a>';
                                                    echo '<div class="remodal" data-remodal-id="modal-map-'.get_sub_field('wahn_profil_standort_ort',$firstPost).'"> <div class="acf-map"> <div class="marker" data-lat="' . $location['lat'] . '" data-lng="' . $location['lng'] . '"></div> </div> </div>';
                                                }

                                                if ($counter != count(get_field('wahn_profil_standort',$firstPost)))
                                                    echo ', ';
                                                $counter++;
            ...
            <?php if (get_field('einsatzgebiet',$firstPost)) : ?>
            <li style="display:none;"><span>Einsatzgebiet</span>
              <?php the_field('einsatzgebiet',$firstPost); ?>
            </li>
            <?php endif; ?>
            <?php if (get_field('bereit_zu_reisen',$firstPost)) : ?>
            <li><span>Bereit zu reisen? </span>
              <?php the_field('bereit_zu_reisen',$firstPost); ?>
            </li>
            <?php endif; ?>
            <?php if (get_field('preiskategorie',$firstPost)) : ?>
            <li><span>Preiskategorie </span>
              <?php the_field('preiskategorie',$firstPost); ?>
            </li>
            <?php endif; ?>
            <?php if (get_field('zusatzleistungen',$firstPost)) : ?>
            <li><span>Zusatzleistungen: </span>
              <?php the_field('zusatzleistungen',$firstPost); ?>
            </li>
            <?php endif; ?>
  ...
  <div class="entry-content" style="text-align:center;">
    ...
    <div class="text-center">
      ...
      <?php if (get_field('f_video_vendor',$firstPost)) : ?>
      <?php the_field('f_video_vendor',$firstPost); ?>
      <?php endif; ?>
      </div>
      <div class="faqs_wrap">
        ...
        <?php wp_reset_postdata(); ?>
        <?php
                        if (have_rows('faqs',$firstPost)):
							echo '<h3>Oft gestellte Fragen</h3>';
                            // loop through the rows of data
                            while (have_rows('faqs',$firstPost)) : the_row();
                                // display a sub field value
                                echo'<div id="faq_container"> 
					
                    <div class="faq">
                        <div class="faq_question"> <span class="fa fa-question-circle"></span><span class="question">' . get_sub_field('faq_question',$firstPost) . '</span></div>
                            <div class="faq_answer_container">
                                <div class="faq_answer"><span class="fa fa-check-circle"></span><span>' . get_sub_field('faq_answer',$firstPost) . '</span></div>
                            </div>
                    </div>
                     </div>';
                            endwhile;
